...
$(document).ready(function(){
    ...
    const features = $('.featured-slider');
    ...
    // MOBILE LEADERSHIP SLIDER START
    const leadership = $('.leadership-slider');
    ...
    // MOBILE LEADERSHIP SLIDER END

    // MOBILE LEADSHIP SLIDER START
    const leadship = $('.leadship-slider');
    
    if(leadship.length > 0) {
        leadship.owlCarousel({
            margin: 12,
            loop: true,
            autoplay: true,
            autoplayTimeout: 5000,
